  ...
  return (
    <Layout>
      <div>
        <table>
            <tr>
                <td rowSpan={2}><img src={eric} class="profilImg" alt="PP Eric" /></td>  
                <td class="gras align-bottom">Eric</td>             
            </tr>
            <tr> 
                <td class="petit align-top">à 3km de chez vous</td>             
            </tr>
        </table> 

        <p class="ml-3 mb-3">Vends :</p> 
        <img src={tomates} class="imgProduit" alt="Images tomates" />
        <div class="flex justify-between">
            <p class="ml-3">Tomates</p>
            <p class="mr-3">2€/kg</p>
        </div>
